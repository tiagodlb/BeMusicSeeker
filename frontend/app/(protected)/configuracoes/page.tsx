...
import { useTheme } from 'next-themes' // ✅ Importação necessária
import {
  Home,
  Zap,
  BarChart3,
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="w-full justify-start gap-3 h-auto py-2">
              <Avatar className="w-9 h-9">
                <AvatarFallback className="bg-gradient-to-br from-blue-500 to-purple-600 text-white text-sm">TS</AvatarFallback>
              </Avatar>
...
export default function ConfiguracoesPage() {
  ...
  // Previne renderização incorreta no servidor
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <Avatar className="w-20 h-20">
                    <AvatarFallback className="bg-gradient-to-br from-primary to-purple-600 text-white text-2xl">TS</AvatarFallback>
                  </Avatar>
                  <div>
